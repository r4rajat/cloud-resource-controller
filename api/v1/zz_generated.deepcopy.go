...
func (in *CreatedEC2InstanceInfo) DeepCopyInto(out *CreatedEC2InstanceInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CreatedEC2InstanceInfo.
func (in *CreatedEC2InstanceInfo) DeepCopy() *CreatedEC2InstanceInfo {
	if in == nil {
		return nil
	}
	out := new(CreatedEC2InstanceInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StorageConfiguration) DeepCopyInto(out *StorageConfiguration) {
	*out = *in
	...
	if in.AdditionalVolumes != nil {
		...
		*out = make([]VolumeConfifuration, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeConfifuration) DeepCopyInto(out *VolumeConfifuration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeConfifuration.
func (in *VolumeConfifuration) DeepCopy() *VolumeConfifuration {
	if in == nil {
		return nil
	}
	out := new(VolumeConfifuration)
	in.DeepCopyInto(out)
	return out
}
